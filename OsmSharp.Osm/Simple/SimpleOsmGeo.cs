...
namespace OsmSharp.Osm.Simple
{
    ...
    public class SimpleOsmGeo
    {
      ...
      public string GetObjectType()
      {
        switch (Type)
        {
          case SimpleOsmGeoType.Node: { return "Точка"; }
          case SimpleOsmGeoType.Way: { return "Путь"; }
          case SimpleOsmGeoType.Relation: { return "Отношение"; }
        }
        return "";
      }
      ...
      {
        return String.Format("{0} {1} {2}", GetObjectType(), Id, String.IsNullOrEmpty(Name) ? "" : ("\"" + Name + "\""));
      }
    }
}
