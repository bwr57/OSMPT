...
namespace OsmSharp.Routing
{
        ...
        where TEdgeData : IDynamicGraphEdgeData
    {
        ...
        public OsmSharpRoute Calculate(VehicleEnum vehicle, RouterPoint source, RouterPoint target, float max)
        {
            ...
            Points = new Dictionary<RoutePointEntry, string>((_router as DykstraRoutingLive).Points.Count);
            foreach (PathSegment<long> path in (_router as DykstraRoutingLive).Points.Keys)
            {
                GeoCoordinate coordinate = this.GetCoordinate(path.VertexId);
                ...
                Points.Add(first, (_router as DykstraRoutingLive).Points[path]);
            }
        ...
        /// 
        /// </summary>
        public Dictionary<RoutePointEntry, string> Points = null;
