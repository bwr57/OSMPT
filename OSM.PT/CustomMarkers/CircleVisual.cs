...
namespace Demo.WindowsPresentation.CustomMarkers
{
    public class CircleVisual : FrameworkElement
   {
      ...
      private Pen strokeEllipse = new Pen(Brushes.Blue, 2.0);
      public Pen StrokeEllipse
      {
         get
         {
            return strokeEllipse;
      ...
      private Brush arrowBackground = Brushes.AliceBlue;
      ...
      private DrawingVisual Create()
      {
         ...
         {
             dc.DrawEllipse(null, StrokeEllipse, new Point(Width / 2, Height / 2), Width / 2 + Stroke.Thickness / 2, Height / 2 + Stroke.Thickness / 2);
             ...
             if (Angle.HasValue)
             {
                 dc.PushTransform(new RotateTransform(Angle.Value, Width / 2, Height / 2));
                 {
                     ...
                     dc.DrawGeometry(ArrowBackground, StrokeArrow, pathGeo);
                 }
                 dc.Pop();
             }
